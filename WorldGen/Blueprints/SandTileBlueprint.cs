...
{
    public class SandTileBlueprint : IEntityBlueprint
    {
        public void Apply(Game world, int entityId, BlueprintSettings settings)
        {
            ...
            world.EntityManager.Renderables.Add(entityId, new RenderComponent {Size = size, Color = Color.Beige, Layer = RenderLayer.Background});
