...
{
    public class WaterTileBlueprint : IEntityBlueprint
    {
        public void Apply(Game world, int entityId, BlueprintSettings settings)
        {
            ...
            world.EntityManager.Renderables.Add(entityId, new RenderComponent {Size = size, Color = Color.Blue, Layer = RenderLayer.Background});
