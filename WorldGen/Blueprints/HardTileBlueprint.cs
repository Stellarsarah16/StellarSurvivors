...
{
    public class HardTileBlueprint : IEntityBlueprint
    {
        public void Apply(Game world, int entityId, BlueprintSettings settings)
        {
            ...
            world.EntityManager.Renderables.Add(entityId, new RenderComponent {Size = size, Color = new Color(150,150,100), Layer = RenderLayer.Background});
